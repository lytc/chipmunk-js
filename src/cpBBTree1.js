...
//static void
BBTree.prototype.pairsClear = function(leaf)
{
    /*cpBBTree **/var tree = this;
...
//static void
BBTree.prototype.nodeRecycle = function(node)
{
    /*cpBBTree **/var tree = this;
...
//static inline void
BBTree.prototype.nodeReplaceChild = function(parent, /*Node **/child, /*Node **/value)
{
    /*cpBBTree **/var tree = this;
    if (NDEBUG) {
...
//static Node *
BBTree.prototype.subtreeInsert = function(/*Node **/subtree, /*Node **/leaf)
{
    /*cpBBTree **/var tree = this;
	if(subtree == null){
		return leaf;
		...
		if(cost_b < cost_a){
            subtree.setB(tree.subtreeInsert(subtree.B, leaf));
		} else {
            subtree.setA(tree.subtreeInsert(subtree.A, leaf));
		}
...
//static inline Node *
BBTree.prototype.subtreeRemove = function(/*Node **/subtree, /*Node **/leaf)
{
    /*cpBBTree **/var tree = this;
	if(leaf == subtree){
		return null;
		...
		if(parent == subtree){
            ...
            tree.nodeReplaceChild(parent.parent, parent, parent.other(leaf));
			return subtree;
		}
	}
}
